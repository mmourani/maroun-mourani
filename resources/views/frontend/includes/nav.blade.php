<div class="agiletopbar">
    ...
    <ul>
        <li class="agileinfomenu"><a href="#" ><p>MENU</p></a></li>
        <li class="aitslogow3ls"> <a href="/"><div class="agilelogo">My Career</div></a></li>
        <li class="wthreecontact"><p><a class="scroll" href="#contact"><i class="fa fa-envelope-o" aria-hidden="true"></i> CONTACT ME</a></p></li>
    </ul>
</div>
